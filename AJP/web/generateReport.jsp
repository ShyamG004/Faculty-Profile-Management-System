    ...
    <body>
        ...
        <div class="tabs" style="display:none;">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    <a href="#" onclick="showEducations()" id="b1">Educational Qualifications</a>
                    <a href="#" onclick="showExperience()" id="b2">Professional Experiences</a>
                    <a href="#" onclick="showProjects()" id="b3">Projects</a>
                    <a href="#" onclick="showConferences()" id="b4">Conferences</a>
                    <a href="#" onclick="showJournals()" id="b5">Journals</a>
                </div>
            </div>
                        ...
                        <div style="position: relative;">
                            ...
                            <div style="margin-top: 10px;">
                                <form action="UploadImageServlet" method="post" enctype="multipart/form-data">
                                    ...
                                    <button type="submit" style="background-color:#28a745; color: white; border: none; padding: 10px 20px; cursor: pointer; border-radius: 5px; margin-bottom:10px;display:none;" onclick="document.getElementById('profileImageInput').click();">Change Profile Image</button>
                                </form>
                            </div>
...
//
//                // Select the part of the webpage to capture (you can target specific sections too)
//                const element = document.querySelector("body");
//
//                // Use html2canvas to capture the visual content of the webpage
//                html2canvas(element, {scale: 2}).then(function (canvas) {
//                    const imgData = canvas.toDataURL("image/png");
//                    const pdf = new jsPDF('p', 'mm', 'a4');  // A4 page size in portrait
//
